...
Non ce n'est pas etrange, il faut juste tester les methodes utiliser pour verifier quelle fonctionnent correctement et pas seulement dans le cas de notre utilisation dans le constructeur
